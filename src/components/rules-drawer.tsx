    ...
    <Drawer open={rulesDrawerIsOpen}>
      <DrawerContent>
        ...
        <article className='hide-scrollbar overflow-auto prose pt-2 pb-8 px-8'>
          ...
          <p className='text-sm text-muted-foreground'>
            The game concludes when players have completed their scorecards with
            13 entries. Final scores are then calculated, incorporating any
            bonus points.
          </p>
          ...
          <p className='text-sm text-muted-foreground'>
            A player may roll the dice up to 3 times, although they may stop and
            score after the first or second roll if they choose.
          </p>
          ...
          <p className='text-sm text-muted-foreground'>
            Tap each box only once, in any order, depending on your best scoring
            option.
          </p>
          ...
          <p className='text-sm text-muted-foreground'>
            ...
            scoring three of each number (Ones through Sixes); however, a player
            may earn the bonus with any combination of scores totaling 63 points
            or more.
          </p>
          ...
          <p className='text-sm text-muted-foreground'>
            A Yachtsea is when a player rolls 5 of the same number, or a `5 of a
            Kind`.
          </p>
          <p className='text-sm text-muted-foreground'>
