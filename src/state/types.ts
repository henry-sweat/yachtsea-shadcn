...
export enum GameState {
  ...
  DiceAreRolling = 'diceAreRolling',
  RoundIsOver = 'roundIsOver',
  AwaitingSecondRollOrScoreSelection = 'awaitingSecondRollOrScoreSelection',
  AwaitingThirdRollOrScoreSelection = 'awaitingThirdRollOrScoreSelection',
  AwaitingScoreSelection = 'awaitingScoreSelection',
  AwaitingFinalScoreSelection = 'awaitingFinalScoreSelection',
}
